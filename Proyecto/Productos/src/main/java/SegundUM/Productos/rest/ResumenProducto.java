...
/** Proyección reducida de Producto para listados de historial con soporte HATEOAS. */
public class ResumenProducto extends RepresentationModel<ResumenProducto> {
