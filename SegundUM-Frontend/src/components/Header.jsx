...
function Header() {
    ...
    const [administrador, toggleAdmin] = useState(false);
                ...
                >
                    ...
                    <Offcanvas.Body>
                        <Nav className="justify-content-end flex-grow-1 pe-3">
                            ...
                            {administrador &&(
                                <NavDropdown title="Administrador" id='productos-dopdown'>
                                    <NavDropdown.Item as={Link} to="/compraventasEntre" onClick={handleClose}>Compraventas entre</NavDropdown.Item>
                                    <NavDropdown.Item as={Link} to="/listaUsuarios" onClick={handleClose}>Lista de Usuarios</NavDropdown.Item>
                                </NavDropdown>
                            )}
